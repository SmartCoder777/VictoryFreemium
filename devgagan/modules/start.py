...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/VictoryAnthem")],
        ]
    )
...
async def plan(client, message):
    plan_text = (
        "> 💰 **Premium Price**:\n\n Starting from $2 or 100 INR accepted via **__Amazon Gift Card__** (terms and conditions apply).\n"
